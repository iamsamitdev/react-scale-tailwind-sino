          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <img
                ...
                src={currentUser?.avatar || "/images/avatar.avif"}
                alt="Profile"
              />
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 py-1 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                ...
                <button
                  ...
                  className="block w-full text-left cursor-pointer px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  ออกจากระบบ
                </button>
              </div>
